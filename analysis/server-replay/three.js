...
let src = require('fs').readFileSync(__dirname + '/node_modules/three/three.js');
let src2 = require('fs').readFileSync(__dirname + '/node_modules/three/CanvasRenderer.js');
...
Canvas.Image.prototype.addEventListener = function(type, listener, useCapture) {
...
window.THREE.Image = Canvas.Image;
