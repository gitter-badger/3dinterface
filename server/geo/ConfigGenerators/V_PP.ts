...
module geo {
     ...
     */
    export class V_PP_Generator extends ConfigGenerator {
        /**
         ...
         * @returns an array with one element corresponding the camera frustum, and other for eventual recommendations to preload
         */

        generateMainConfig(cameraFrustum? : Frustum, recoClicked? : number) : Config {
