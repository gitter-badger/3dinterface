...
src/mth/typings/node_modules/.dirstamp: src/mth/package.json
	$(CD) src/mth/ && $(NPM) install
	$(TOUCH_DIRSTAMP)

src/mth/build/.dirstamp: src/mth/*.ts src/mth/package.json src/mth/tsconfig.json src/mth/typings/.dirstamp src/mth/typings/node_modules/.dirstamp
	$(CD) src/mth/ && $(TSC)
	$(TOUCH_DIRSTAMP)
